...
SLOT="0"
IUSE="+bluetooth +browser-extension elogind gtk-doc +ibus +networkmanager systemd telepathy test gdm polkit pipewire"
...
DEPEND="
	...
	polkit? ( >=sys-auth/polkit-0.120_p20220509[introspection] )
...
PDEPEND="
gdm? ( >=gnome-base/gdm-3.5[introspection(+)] )
